...
int main(int argc, char** argv)
{
	...
	std::list<const sdds::Vehicle*> vehicles;
	{
		...
		auto fastVehicles = [](const sdds::Vehicle* src_vehicle) {
			return src_vehicle->topSpeed() > 300;
		};
	...
	std::cout << std::endl;
	{
		...
		auto brokenVehicles = [](const sdds::Vehicle* src_vehicle) {
			return src_vehicle->condition() == "broken";
		};
